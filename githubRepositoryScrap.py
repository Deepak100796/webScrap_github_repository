...
print(json.dumps(scrap_website("https://github.com/Deepak100796?tab=repositories"), indent=4))

parsed_uri = urlparse("https://github.com/Deepak100796?tab=repositories")
